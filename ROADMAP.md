...
**Status Gesamtprojekt:** 🟡 M1 (Fundament), M2 (Generator), M3 (Veranstaltungen) und M4 (Matrix & Auswertung) abgeschlossen (F3.7 zurückgestellt auf 1.1), M5 (Automatisierung) in Arbeit (F5.1, F5.2 fertig)
