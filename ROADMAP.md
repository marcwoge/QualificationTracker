...
**Status Gesamtprojekt:** 🟡 M1 (Fundament), M2 (Generator) und M3 (Veranstaltungen) abgeschlossen (F3.7 zurückgestellt auf 1.1), M4 (Matrix & Auswertung) in Arbeit (F4.1, F4.2 fertig)
